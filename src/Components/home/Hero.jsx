...
const Hero = () => {
  ...
  return (
    <section className="relative w-full h-[80vh] lg:min-h-screen overflow-hidden flex items-center justify-center bg-[#2A2A2A]">
      ...
      >
        <Image alt="hero" width={500} height={500} className="w-full h-full" src="https://i.ibb.co.com/qLqvyzZT/istockphoto-2164617622-612x612.jpg"></Image>
        ...
        <h1 className="text-4xl md:text-6xl lg:text-8xl font-black tracking-tighter leading-none overflow-hidden">
          ...
          <span className="block overflow-hidden">
            <motion.span 
              ...
              className="text-transparent bg-clip-text bg-linear-to-r pb-3 from-cyan-400 to-blue-500 inline-block"
            >
              Day Beautiful
            </motion.span>
          </span>
