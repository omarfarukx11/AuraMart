...
const DashboardLayout = ({ children }) => {
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      <aside className="hidden md:flex flex-col w-72 bg-white border-r border-gray-200 sticky top-0 h-screen shadow-sm">
        <div className="p-6 border-b border-gray-50">
          <Link href="/" className="text-2xl font-black text-blue-600 tracking-tighter uppercase">
            AuraMart
          </Link>
        </div>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="h-20 bg-white border-b border-gray-200 flex items-center justify-end px-8 sticky top-0 z-10">
          <div className="flex items-center gap-3">
            <span className="text-xl font-medium text-gray-500">Admin Panel</span>
