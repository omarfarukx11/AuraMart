    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-950">
            <div className="relative flex flex-col m-6 space-y-8 bg-white dark:bg-slate-900 shadow-2xl rounded-2xl md:flex-row md:space-y-0">
                ...
                >
                    <h1 className="mb-3 text-4xl font-black text-slate-900 dark:text-white">Welcome Back</h1>
                    <p className="font-light text-slate-600 dark:text-slate-400 mb-8">
                        Sign in to access your account, view your orders, and enjoy a seamless shopping experience with AuraMart.
                    </p>
                    ...
                    <form className="flex flex-col space-y-5">
                        ...
                        <div className="flex items-center justify-between">
                            <label className="flex items-center text-sm text-slate-600 dark:text-slate-400">
                                <input type="checkbox" className="mr-2 rounded border-slate-300 text-sky-500 focus:ring-sky-500" />
                                Remember Me
                            </label>
                    ...
                    <div className="relative flex items-center my-6">
                        ...
                        <span className="shrink mx-4 text-xs text-slate-400 uppercase">Or sign in with</span>
                        <div className="grow border-t border-slate-200 dark:border-slate-700"></div>
                    </div>
                ...
                >
                    <img
                        src="https://images.unsplash.com/photo-1590055531733-faf7617b4c63?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80"
